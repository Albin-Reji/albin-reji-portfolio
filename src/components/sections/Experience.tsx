    ...
    >
      ...
      <div className="exp-header-trigger px-6 md:px-12 max-w-[1728px] mx-auto mb-8 md:mb-12">
        <div className="flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.25em] text-[#8A8A8A] mb-4 border-b border-[#F5F5F0]/15 pb-3">
          <span className="text-[#DDFE67] font-bold">[TRACK // 04]</span>
        ...
        <div className="overflow-hidden">
          <h2 className="exp-header-line text-[clamp(2.5rem,7vw,7.5rem)] font-black uppercase leading-[0.85] tracking-[-0.05em] text-[#DDFE67]">
      ...
      <div className="exp-timeline-container px-6 md:px-12 max-w-[1728px] mx-auto relative">
        ...
        <div
          ref={timelineLineRef}
          className="hidden md:block absolute left-[33.333%] top-0 bottom-0 w-px bg-[#DDFE67] origin-top pointer-events-none"
          aria-hidden="true"
        />
            ...
            return (
              ...
              >
                ...
                <div className="md:col-span-4 space-y-2 md:text-right md:pr-12">
                  <span className="exp-item-fade font-mono text-[10px] lowercase tracking-[0.2em] text-[#777771] block">
                    {exp.duration}
                  </span>
                  <div className="exp-item-fade space-y-1">
                    <p className="font-mono text-base uppercase tracking-wider text-[#F5F5F0] font-bold group-hover:text-[#DDFE67] transition-colors">
                      {exp.company}
                    </p>
                    {exp.location && (
                      <p className="font-mono text-[10px] lowercase tracking-wider text-[#777771]">
                        {exp.location}
                      </p>
                    )}
                  </div>
                ...
                <div className="md:col-span-8 space-y-6 md:pl-12 border-t md:border-t-0 border-[#F5F5F0]/15 pt-6 md:pt-0">
                  <div className="exp-item-fade space-y-2">
                    <div className="flex items-center gap-3">
                      <span className="font-mono text-xs text-[#DDFE67] font-bold">
                        // 0{num}
                      </span>
                    ...
                    {exp.project && (
                      <p className="font-mono text-xs uppercase tracking-[0.2em] text-[#DDFE67]">
                  ...
                  <ul className="exp-item-fade space-y-3 font-light text-sm md:text-base text-[#B5B5B5]">
                    {exp.responsibilities.map((resp, rIdx) => (
                      <li
                        key={rIdx}
                        className="pl-5 relative before:content-['—'] before:absolute before:left-0 before:text-[#DDFE67] leading-relaxed"
                      >
                        {resp}
                      </li>
                    ))}
                  ...
                  <div className="exp-item-fade pt-2 flex flex-wrap gap-2">
                    {exp.techTags.map((tech) => (
                      <span
                        key={tech}
                        className="font-mono text-[10px] uppercase tracking-wider border border-[#F5F5F0]/15 px-3 py-1 text-[#8A8A8A] hover:border-[#DDFE67] hover:text-[#DDFE67] transition-colors bg-[#050505]"
                      >
                        {tech}
                      </span>
                    ))}
