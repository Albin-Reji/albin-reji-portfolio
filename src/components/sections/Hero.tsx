...
export default function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      id="home"
      className="relative min-h-screen flex flex-col justify-between overflow-visible lg:overflow-hidden bg-transparent border-b border-[#F5F5F0]/15"
    >
      {/* ═══ Main Viewport Composition (Proper clearance for fixed navbar) ═══ */}
      <div className="relative z-10 flex-1 flex items-center px-6 md:px-12 max-w-[1728px] mx-auto w-full pt-28 sm:pt-32 lg:pt-32 pb-12 sm:pb-16 lg:pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center w-full">
          ...
          <div
            ...
            className="lg:col-span-5 relative w-full max-w-[360px] sm:max-w-[440px] lg:max-w-none h-[460px] sm:h-[520px] lg:h-[600px] mx-auto flex items-center justify-center mt-6 lg:mt-0 mb-4 lg:mb-0"
          >
